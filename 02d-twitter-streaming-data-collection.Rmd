...
consumerKey <- "MoL5dKxIQpMtGXSqLJtizvYPw" #YOUR CONSUMER KEY HERE
consumerSecret <- "9Tl8w0hkrW2DEo7JYUeLeh1u0992t1L6kLLNGnZWSmZehnqX4z" #YOUR_CONSUMER_SECRET
...
- `timeout` is the number of seconds that the connection will remain open. Set it to 0 for having it running unfinitely.
...
Check the original json file to understand the difference between the number of rows in the parsed object and the output comment from the `filterStream` function used before (which says "up to").
```{r}
