...
- The __fast and greedy__ method tries to directly optimize this modularity score. It takes advante of parallel processing, which essential to optimise network procressing.
